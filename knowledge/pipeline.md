...
| 9 | Editorialschicht | About, Imprint, Review Criteria, optional Reviewer profiles as Markdown with frontmatter; per-issue YAML config; consistency check against TEI headers | [[requirements#R10 Statische Inhalte pflegen]], [[requirements#R11 Issue-Metadaten pflegen]], [[requirements#A3 Redaktionelle Texte]] |
