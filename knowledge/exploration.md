...
Der Korpus sind 111 Reviews in 22 Issues über zwölf Jahre (Review-Daten 2014-06 bis 2026-05). Der universelle Join-Schlüssel ist der Review-Dateiname; er verbindet `taxonomy.json`, `refs.json`, `sections.json` und den Issue-Ordnerpfad lückenlos (111/111; das hier ursprünglich mitgenannte `corpus-stats.json` wird seit dem Refactoring 2026-07-10 nicht mehr erzeugt, seine Felder liefert der Parser direkt). Fünf Dimensionen tragen, jede mit eigener Reichweite und eigenen Grenzen. Die Strukturdetails stehen in [[data]]; hier die explorationsrelevante Verdichtung.
